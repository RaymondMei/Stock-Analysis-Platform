...
from .views import getStockHistoricalData, getStockHistory, getStockResults, getStockQuote
...
urlpatterns = [
	...
	path('stockhistoricaldata', view=getStockHistoricalData, name='stockhistoricaldata'),
